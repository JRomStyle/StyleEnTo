<h1 class="text-2xl font-bold tracking-tight text-slate-900 mb-4">Nueva categoría</h1>
<form class="bg-white border border-slate-200/70 rounded-2xl shadow-soft p-6 space-y-4" method="post" action="?route=admin/categoryCreate">
    <?php echo csrf_field(); ?>
    <div>
