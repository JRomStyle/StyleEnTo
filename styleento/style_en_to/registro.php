...
<body class="bg-white text-black">
  <main class="min-h-screen grid place-items-center px-5 py-12">
    <div class="w-full max-w-md border border-black/10 rounded-[2.5rem] p-8 bg-white shadow-2xl">
      ...
      <h1 class="mt-6 text-3xl font-extrabold tracking-tight text-black">Crear cuenta</h1>
      ...
      <form class="mt-6 grid gap-4" method="post" action="<?= e(url('registro.php')) ?>">
        ...
        <div>
          ...
          <input name="nombre" class="mt-2 w-full rounded-2xl border border-black/10 px-4 py-3 outline-none focus:border-black/30 text-black" placeholder="Tu nombre" required />
        </div>
        <div>
          <label class="text-sm font-semibold text-black">Email</label>
          <input name="email" type="email" class="mt-2 w-full rounded-2xl border border-black/10 px-4 py-3 outline-none focus:border-black/30 text-black" placeholder="tu@email.com" required />
        </div>
        <div>
          <label class="text-sm font-semibold text-black">Contraseña</label>
          <input name="password" type="password" class="mt-2 w-full rounded-2xl border border-black/10 px-4 py-3 outline-none focus:border-black/30 text-black" placeholder="Mínimo 6 caracteres" required />
        </div>
