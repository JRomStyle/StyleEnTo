...
<div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold">Agregar Categoría</h2>
    ...
    <form action="<?php echo URLROOT; ?>/categories/add" method="post">
        ...
        <input type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full cursor-pointer" value="Guardar">
    </form>
</div>
